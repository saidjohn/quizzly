...
import 'package:quizzly/services/constants/strings/strings.dart';
                  ...
                  child: Container(
                    ...
                    child:  Column(
                      children: [
                        ...
                        Text("${l10n.question} ${(controller.currentQuiz +1).toString().padLeft(2,"0")}/${controller.dataQuiz.length}",
