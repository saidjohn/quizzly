...
import '../services/constants/strings/strings.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(image: AppImage.image, fit: BoxFit.fill,),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: MyTextButton(
                  text: l10n.level1, controller: controller, onPressed: () => FirstPageController.buttonLevelOne(context),
                ),
              ),
              const Spacer(flex: 2),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 45, right: 45),
                child: MyTextButton(
                  controller: controller, onPressed: () => FirstPageController.buttonLevelTwo(context),
                  text: l10n.level2,
                ),
              ),
              const Spacer(flex: 2),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 45, right: 45),
                child: MyTextButton(
                  controller: controller, onPressed: () => FirstPageController.buttonLevelThree(context),
                  text: l10n.level3,
                ),
              ),
              const Spacer(flex: 6),
